  ...
  return (
    <li className={styles.restaurant}>
      <div className={styles.restaurantCategory}>
        <img
          src="self-paced-react\templates\category-korean.png"
          alt="한식"
      ...
      <div className={styles.restaurantInfo}>
        ...
        <p className={`${styles.restaurantDescription} text-body`}>
          ...
          사투리로 ‘평양’을 의미한다. 딸과 함께 운영하는 이곳에선 맷돌로 직접 간
          콩만을 사용하며, 일체의 조미료를 넣지 않은 건강식을 선보인다. 콩비지와
          피양 만두가 이곳의 대표 메뉴지만, 할머니가 옛날 방식을 고수하며
          만들어내는 비지전골 또한 이 집의 역사를 느낄 수 있는 특별한 메뉴다.
